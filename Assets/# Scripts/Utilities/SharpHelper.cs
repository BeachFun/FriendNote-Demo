...
{
    /// <summary>
    /// Проверяет дату на значение по-умолчанию
    /// </summary>
    internal static bool IsDefault(this DateTime date)
    {
        return date.ToString("dd.MM.yyyy") == "01.01.0001";
    }
    /// <summary>
    /// Проверяет nullable дату на значение по-умолчанию
    /// </summary>
    internal static bool IsDefault(this DateTime? date)
    {
        return (!date.HasValue || IsDefault(date.Value));
    }
