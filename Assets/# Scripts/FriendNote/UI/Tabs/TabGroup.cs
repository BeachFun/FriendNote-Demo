...
namespace FriendNote.UI
{
    ...
    public class TabGroup : MonoBehaviour
    {
        ...
        [SerializeField] private List<TabButton> tabButtons; // кнопки переключения
        [SerializeField] private List<GameObject> sectionToSwap; // разделы для переключения
        [Space, SerializeField] private uint _currentSelectedButton; // текущая выбранная кнопка
        ...
        /// <summary>
        /// Внесение в список кнопки в список кнопок переключения, если она еще не внесена
        /// </summary>
