...
{
    public class UI_EditSection_Address : MonoBehaviour, IDataUpdating<Address>, ICollectable<Address>, IFieldsReseting
    {
        [Header("Settings")]
        ...
        private void Awake()
        {
            ...
            // Подписка на события поля TMP_InputField
        ...
        public void DataUpdate(Address Address)
        {
