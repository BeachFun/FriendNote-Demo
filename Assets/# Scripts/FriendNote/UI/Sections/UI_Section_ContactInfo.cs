...
namespace FriendNote.UI
{
    public class UI_Section_ContactInfo : MonoBehaviour
    {
        ...
        private void GenerateContactsCards(PersonContacts personContacts)
        {
            ...
            // Генерация карточек с телефонными номерами
            ...
            // Генерация карточек с социальными сетями
            ...
            // Генерация карточек с электронными почтами
            ...
            // Генерация карточек с остальными контактными данными
