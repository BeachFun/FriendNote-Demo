...
/// <summary>
/// Класс для сохранения данных в буфере обмена на разных платформах
/// </summary>
...
sealed class StandardBoard : IBoard
{
...
#if UNITY_ANDROID
sealed class AndroidBoard : IBoard
{
    public void SetText(string str)
    {
